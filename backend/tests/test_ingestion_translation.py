...
class TestNormaliseWithTranslation:
    def test_italian_url_article_gets_translated(self):
        ...
        with patch(
            ...
            article, _, _ = _normalise(item, _italian_cfg())
    ...
    def test_hebrew_article_not_translated(self):
        ...
        with patch(
            ...
            article, _, _ = _normalise(item, _hebrew_cfg())
    ...
    def test_translation_failure_keeps_original_title(self):
        ...
        with patch(
            ...
            article, _, _ = _normalise(item, _english_cfg())
...
class TestHebrewSourceInvariant:
    ...
    def test_future_hebrew_source_never_calls_provider(self):
        ...
        with patch("app.ingestion.ingestion_service.translate_title") as mock_tr:
            article, _, _ = _normalise(item, sport5_cfg)
