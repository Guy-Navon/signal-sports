...
> **Active track (2026-07-10): User Platform** — real accounts, authentication, onboarding, and per-user data isolation wrapped around the existing FACTS → VISIBILITY → PREFERENCE → LEARNING pipeline; contract `docs/USER_PLATFORM.md`; canonical graph in Epic #48. The Classification & Feed Reliability core track is **complete** (#59–#63 closed, Epic #58; the former #52 gate cleared 2026-07-10); its leftovers #64/#65 are open and non-blocking, and the golden-17 suite is a standing regression contract. **Canonical next actions (2026-07-10): #54's independent security/regression review + the owner's physical phone/Tailscale pass → merge PR #75 → #55 (account lifecycle) completes the milestone. #64/#65 stay deferred behind this critical path.**
...
1. **User Platform** (Milestone 2, Epic #48, issues #49–#55) — real accounts,
   ...
   (account lifecycle) follows it.** Contract: `docs/USER_PLATFORM.md`.
