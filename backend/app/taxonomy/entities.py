...
_ALL_ENTITIES: tuple[TaxonomyEntity, ...] = (
    ...
    _team("team:maccabi_kiryat_gat", "basketball", "מכבי קריית גת", "Maccabi Kiryat Gat",
          ...
          family="מכבי", domestic="comp:ibl"),
    # ── #40 Part A — evidence-based IBL additions (real-DB coverage / established
    #    top-flight clubs). Roster is season-volatile; see docs/TAXONOMY.md audit. ──
    _team("team:ironi_kiryat_ata", "basketball", "עירוני קריית אתא", "Ironi Kiryat Ata",
          "Ironi Kiryat Ata",
          ("עירוני קריית אתא", "עירוני קרית אתא", "קריית אתא", "קרית אתא",
           "ironi kiryat ata", "kiryat ata"),
          family="עירוני", domestic="comp:ibl"),
    # Shares the bare "הפועל באר שבע" forms with the football club — the resolver's
    # cross-sport ambiguity mechanism handles it (like Maccabi/Hapoel Tel Aviv).
    _team("team:hapoel_beer_sheva_bb", "basketball", "הפועל באר שבע", "Hapoel Beer Sheva BC",
          "Hapoel Beer Sheva Basketball",
          ("הפועל באר שבע", 'הפועל ב"ש', "hapoel beer sheva",
           "הפועל באר שבע/דימונה", "באר שבע/דימונה"),
          family="הפועל", domestic="comp:ibl"),
    _team("team:hapoel_haifa_bb", "basketball", "הפועל חיפה", "Hapoel Haifa BC",
    ...
    _team("team:hapoel_beer_sheva_fc", "football", "הפועל באר שבע", "Hapoel Beer Sheva",
          ...
          ("הפועל באר שבע", 'הפועל ב"ש', "hapoel beer sheva"),
          family="הפועל", domestic="comp:ligat_haal"),
    # Registered alongside the new basketball club so the shared "הפועל חיפה" forms
    # stay cross-sport ambiguous instead of silently resolving to one sport.
    _team("team:hapoel_haifa_fc", "football", "הפועל חיפה", "Hapoel Haifa",
    ...
    # ── #40 Part A — EuroLeague 2025-26 completion (remaining 8 of 20 clubs).
    #    Clubs whose domestic league is untracked (German BBL, Lithuanian LKL,
    #    ABA) carry the EuroLeague membership only, like Partizan/Crvena Zvezda. ──
    _team("team:baskonia", "basketball", "בסקוניה", "Baskonia",
          "Baskonia",
          ("בסקוניה", "baskonia", "saski baskonia"),
          domestic="comp:acb", extra_memberships=("comp:euroleague",)),
    _team("team:valencia_bb", "basketball", "ולנסיה", "Valencia Basket",
          "Valencia Basket",
          ("ולנסיה", "ולנסיה באסקט", "valencia", "valencia basket"),
          domestic="comp:acb", extra_memberships=("comp:euroleague",), guarded=True),
    _team("team:olimpia_milano", "basketball", "אולימפיה מילאנו", "Olimpia Milano",
          "Olimpia Milano",
          ("אולימפיה מילאנו", "מילאנו", "olimpia milano", "ea7 milano",
           "armani milano", "milano"),
          domestic="comp:lba", extra_memberships=("comp:euroleague",), guarded=True),
    _team("team:asvel", "basketball", "אזוול וילרבאן", "ASVEL Villeurbanne",
          "ASVEL Villeurbanne",
          ("אזוול", "וילרבאן", "אזוול וילרבאן", "asvel", "ldlc asvel",
           "asvel villeurbanne"),
          domestic="comp:lnb", extra_memberships=("comp:euroleague",)),
    _team("team:paris_bb", "basketball", "פריז באסקטבול", "Paris Basketball",
          "Paris Basketball",
          ("פריז", "פריז באסקטבול", "paris", "paris basketball"),
          domestic="comp:lnb", extra_memberships=("comp:euroleague",), guarded=True),
    _team("team:bayern_munich_bb", "basketball", "באיירן מינכן", "Bayern Munich",
          "Bayern Munich Basketball",
          ("באיירן מינכן", "באיירן", "bayern munich", "bayern", "fc bayern"),
          extra_memberships=("comp:euroleague",), guarded=True),
    _team("team:zalgiris", "basketball", "ז'לגיריס קובנה", "Zalgiris Kaunas",
          "Zalgiris Kaunas",
          ("ז'לגיריס", "זלגיריס", "ז'לגיריס קובנה", "זלגיריס קובנה",
           "zalgiris", "zalgiris kaunas"),
          extra_memberships=("comp:euroleague",)),
    _team("team:dubai_bb", "basketball", "דובאי", "Dubai Basketball",
          "Dubai Basketball",
    ...
    _team("team:cleveland_cavaliers", "basketball", "קליבלנד קאבלירס", "Cleveland Cavaliers",
          ...
          ("קאבלירס", "קאבס", "קליבלנד", "קליבלנד קאבלירס", "cavaliers", "cavs",
           "cleveland cavaliers"),
          domestic="comp:nba"),
    # ── #40 Part A — NBA completion (remaining 24 of 30 teams). Alias safety with
    #    the substring resolver: no bare aliases that are common-word substrings
    #    ("nets"⊂cabinets, "kings"⊂vikings, "heat"⊂wheat/להיט, "suns"⊂sunset,
    #    "bucks"=slang money), none shared with football brands ("spurs"=Tottenham,
    #    "wolves"=Wolverhampton, bare "מיאמי"=Inter Miami), no bare "magic"/"jazz"
    #    (Magic Johnson / common words), no bare LA forms (Lakers↔Clippers same-
    #    sport collision is an integrity violation). Hebrew bare-city aliases follow
    #    the existing פורטלנד/קליבלנד precedent where the city is NBA-unique. ──────
    _team("team:brooklyn_nets", "basketball", "ברוקלין נטס", "Brooklyn Nets",
          "Brooklyn Nets",
          ("נטס", "ברוקלין", "ברוקלין נטס", "brooklyn nets", "brooklyn"),
          domestic="comp:nba"),
    _team("team:sacramento_kings", "basketball", "סקרמנטו קינגס", "Sacramento Kings",
          "Sacramento Kings",
          ("קינגס", "סקרמנטו", "סקרמנטו קינגס", "sacramento kings", "sacramento"),
          domestic="comp:nba"),
    _team("team:atlanta_hawks", "basketball", "אטלנטה הוקס", "Atlanta Hawks",
          "Atlanta Hawks",
          ("הוקס", "אטלנטה", "אטלנטה הוקס", "atlanta hawks", "atlanta"),
          domestic="comp:nba"),
    _team("team:charlotte_hornets", "basketball", "שארלוט הורנטס", "Charlotte Hornets",
          "Charlotte Hornets",
          ("הורנטס", "שארלוט", "שארלוט הורנטס", "charlotte hornets", "hornets"),
          domestic="comp:nba"),
    _team("team:chicago_bulls", "basketball", "שיקגו בולס", "Chicago Bulls",
          "Chicago Bulls",
          ("בולס", "שיקגו", "שיקגו בולס", "chicago bulls", "bulls"),
          domestic="comp:nba"),
    _team("team:dallas_mavericks", "basketball", "דאלאס מאבריקס", "Dallas Mavericks",
          "Dallas Mavericks",
          ("מאבריקס", "מאברס", "דאלאס", "דאלאס מאבריקס", "dallas mavericks",
           "mavericks", "mavs", "dallas"),
          domestic="comp:nba"),
    _team("team:denver_nuggets", "basketball", "דנבר נאגטס", "Denver Nuggets",
          "Denver Nuggets",
          ("נאגטס", "דנבר", "דנבר נאגטס", "denver nuggets", "nuggets", "denver"),
          domestic="comp:nba"),
    _team("team:detroit_pistons", "basketball", "דטרויט פיסטונס", "Detroit Pistons",
          "Detroit Pistons",
          ("פיסטונס", "דטרויט", "דטרויט פיסטונס", "detroit pistons", "pistons",
           "detroit"),
          domestic="comp:nba"),
    _team("team:golden_state_warriors", "basketball", "גולדן סטייט ווריורס",
          "Golden State Warriors",
          "Golden State Warriors",
          ("ווריורס", "גולדן סטייט", "גולדן סטייט ווריורס", "golden state warriors",
           "warriors", "golden state"),
          domestic="comp:nba"),
    _team("team:houston_rockets", "basketball", "יוסטון רוקטס", "Houston Rockets",
          "Houston Rockets",
          ("רוקטס", "יוסטון", "יוסטון רוקטס", "houston rockets", "rockets",
           "houston"),
          domestic="comp:nba"),
    _team("team:indiana_pacers", "basketball", "אינדיאנה פייסרס", "Indiana Pacers",
          "Indiana Pacers",
          ("פייסרס", "אינדיאנה", "אינדיאנה פייסרס", "indiana pacers", "pacers",
           "indiana"),
          domestic="comp:nba"),
    _team("team:la_clippers", "basketball", "לוס אנג'לס קליפרס", "LA Clippers",
          "LA Clippers",
          ("קליפרס", "לוס אנג'לס קליפרס", "la clippers", "los angeles clippers",
           "clippers"),
          domestic="comp:nba"),
    _team("team:memphis_grizzlies", "basketball", "ממפיס גריזליס", "Memphis Grizzlies",
          "Memphis Grizzlies",
          ("גריזליס", "ממפיס", "ממפיס גריזליס", "memphis grizzlies", "grizzlies",
           "memphis"),
          domestic="comp:nba"),
    _team("team:miami_heat", "basketball", "מיאמי היט", "Miami Heat",
          "Miami Heat",
          ("מיאמי היט", "miami heat"),
          domestic="comp:nba"),
    _team("team:milwaukee_bucks", "basketball", "מילווקי באקס", "Milwaukee Bucks",
          "Milwaukee Bucks",
          ("באקס", "מילווקי", "מילווקי באקס", "milwaukee bucks", "milwaukee"),
          domestic="comp:nba"),
    _team("team:minnesota_timberwolves", "basketball", "מינסוטה טימברוולבס",
          "Minnesota Timberwolves",
          "Minnesota Timberwolves",
          ("טימברוולבס", "מינסוטה", "מינסוטה טימברוולבס", "minnesota timberwolves",
           "timberwolves", "minnesota"),
          domestic="comp:nba"),
    _team("team:new_orleans_pelicans", "basketball", "ניו אורלינס פליקנס",
          "New Orleans Pelicans",
          "New Orleans Pelicans",
          ("פליקנס", "ניו אורלינס", "ניו אורלינס פליקנס", "new orleans pelicans",
           "pelicans", "new orleans"),
          domestic="comp:nba"),
    _team("team:okc_thunder", "basketball", "אוקלהומה סיטי ת'אנדר",
          "Oklahoma City Thunder",
          "Oklahoma City Thunder",
          ("ת'אנדר", "תאנדר", "אוקלהומה", "אוקלהומה סיטי ת'אנדר",
           "oklahoma city thunder", "thunder", "okc", "oklahoma"),
          domestic="comp:nba"),
    _team("team:orlando_magic", "basketball", "אורלנדו מג'יק", "Orlando Magic",
          "Orlando Magic",
          ("אורלנדו", "אורלנדו מג'יק", "orlando magic", "orlando"),
          domestic="comp:nba"),
    _team("team:philadelphia_76ers", "basketball", "פילדלפיה סבנטי סיקסרס",
          "Philadelphia 76ers",
          "Philadelphia 76ers",
          ("סיקסרס", "פילדלפיה", "פילדלפיה סבנטי סיקסרס", "philadelphia 76ers",
           "76ers", "sixers", "philadelphia"),
          domestic="comp:nba"),
    _team("team:phoenix_suns", "basketball", "פיניקס סאנס", "Phoenix Suns",
          "Phoenix Suns",
          ("סאנס", "פיניקס", "פיניקס סאנס", "phoenix suns", "phoenix"),
          domestic="comp:nba"),
    _team("team:san_antonio_spurs", "basketball", "סן אנטוניו ספרס",
          "San Antonio Spurs",
          "San Antonio Spurs",
          ("ספרס", "סן אנטוניו", "סן אנטוניו ספרס", "san antonio spurs",
           "san antonio"),
          domestic="comp:nba"),
    _team("team:toronto_raptors", "basketball", "טורונטו ראפטורס", "Toronto Raptors",
          "Toronto Raptors",
          ("ראפטורס", "טורונטו", "טורונטו ראפטורס", "toronto raptors", "raptors",
           "toronto"),
          domestic="comp:nba"),
    _team("team:utah_jazz", "basketball", "יוטה ג'אז", "Utah Jazz",
          "Utah Jazz",
          ("יוטה ג'אז", "יוטה", "utah jazz", "utah"),
          domestic="comp:nba"),
